...
$(".tab-faq-section-head li:first-child").toggleClass("active_tab").siblings().removeClass("active_tab");
let head = $(".tab-faq-section-head li:first-child").data("head");
$(".tab-faq-section-content").hide();
  $(`.tab-faq-section-content[data-content="${head}"]`).show();

$("ul.tabs_pop .h4").click(function(){
  $(this).parent("li").toggleClass("active_tab").siblings().removeClass("active_tab");
 $(this).next().slideToggle();
$(this).parent("li").siblings().find("div:not(.h4)").slideUp();
});
$(".tab-faq-section-head li").click(function(){
